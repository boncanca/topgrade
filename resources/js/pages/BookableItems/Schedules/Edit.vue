...
const form = useForm({
    starts_at: formatDateTimeForInput(props.schedule.starts_at),
    ends_at: formatDateTimeForInput(props.schedule.ends_at),
...
function handleSubmit(): void {
    form.put(schedulesUpdate.url([props.activity.id, props.schedule.id]));
}
...
<template>
    <FormPage
        :title="`Edit Schedule - ${activity.name}`"
        description="Update this training session."
    >
